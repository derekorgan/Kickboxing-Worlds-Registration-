...
CREATE TABLE profile (id BIGINT AUTO_INCREMENT, sf_guard_user_id BIGINT, first_name VARCHAR(255), middle_name VARCHAR(255), last_name VARCHAR(255), email_address VARCHAR(255), INDEX sf_guard_user_id_idx (sf_guard_user_id), PRIMARY KEY(id)) ENGINE = INNODB;
