...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `_kickboxing`.`event` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `_kickboxing`.`team_administrator` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `_kickboxing`.`discipline` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `_kickboxing`.`division` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `_kickboxing`.`type` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `_kickboxing`.`attendee` ;
...
-- -----------------------------------------------------
-- Table `_kickboxing`.`event_discipline`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `_kickboxing`.`event_discipline` ;

CREATE  TABLE IF NOT EXISTS `_kickboxing`.`event_discipline` (
  `event_id` INT NOT NULL ,
  `discipline_id` INT NOT NULL ,
  INDEX `fk_event_discipline_event1` (`event_id` ASC) ,
  INDEX `fk_event_discipline_discipline1` (`discipline_id` ASC) ,
  CONSTRAINT `fk_event_discipline_event1`
    FOREIGN KEY (`event_id` )
    REFERENCES `_kickboxing`.`event` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_event_discipline_discipline1`
    FOREIGN KEY (`discipline_id` )
    REFERENCES `_kickboxing`.`discipline` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = 'This lists all active disciplines in a particular event' ;
